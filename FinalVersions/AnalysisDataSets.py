...
df = pd.read_csv(r'D:\!Ilya\MacineLearning\FinalVersions\PJME_hourly.csv', index_col=0, parse_dates=True)
...
def test_stationary(timeseries, window=12):
    ...
    print(dfoutput)
df_2 = pd.read_csv(r'D:\!Ilya\MacineLearning\FinalVersions\cleaned_costs.csv', index_col=0, parse_dates=True)
