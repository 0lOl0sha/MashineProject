...
# Создание модели
model = Sequential()
model.add(LSTM(1000, input_shape=(trainX.shape[1], trainX.shape[2]), activation='linear', return_sequences=True))
model.add(LSTM(1000, activation='linear'))
model.add(Dense(1))
