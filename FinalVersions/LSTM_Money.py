...
look_back = 1  # количество признаков
...
# Создание модели
model = Sequential()
model.add(LSTM(1500, input_shape=(trainX.shape[1], trainX.shape[2])))
model.add(Dense(1))
model.compile(loss='mse', optimizer='adam')
history = model.fit(trainX, trainY, epochs=20, batch_size=10, validation_data=(testX, testY))
